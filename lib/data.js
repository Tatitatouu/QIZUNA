...
export const heroData = {
  title: 'Agence développement web sur mesure — <span>des logiciels qui durent</span>',
  subtitle: 'Développement web, application mobile et logiciel sur mesure pour les entreprises qui veulent un outil qui leur ressemble vraiment.',
  stats: [
...
export const services = [
  {
    ...
    description: 'Applications web métier, SaaS, plateformes et sites sur mesure. Développés en React/Next.js avec une architecture pensée pour évoluer sans dette technique.',
    features: ['React/Next.js', 'Mobile-first', 'Performance optimale'],
    linkText: 'En savoir plus sur notre développement web',
    linkHref: '/developpement-web',
  },
  {
    icon: getIcon('Shield'),
    title: 'Audit technique & sécurité applicative',
    description: "Audit de code, revue d'architecture, détection de failles de sécurité. Nous livrons un rapport clair avec un plan d'action priorisé.",
  ...
  },
  {
    ...
    description: 'Applications iOS et Android natives ou cross-platform (React Native). De la maquette au déploiement sur les stores, avec maintenance incluse.',
    features: ['iOS & Android', 'React Native', 'Déploiement stores'],
    linkText: 'En savoir plus sur notre développement mobile',
